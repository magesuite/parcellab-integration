...
class ClientLanguageCode extends \Magento\Config\Block\System\Config\Form\Field\FieldArray\AbstractFieldArray
{
    /**
    ...
    protected function _prepareToRender()
    {
        ...
        $this->addColumn('client_language_code', ['label' => __('Language Code')]);
    ...
    public function renderCellTemplate($configurationColumnName)
    {
        ...
        if ($configurationColumnName == 'client_language_code' && isset($this->_columns[$configurationColumnName])) {
